...
const About = () => {
    return (
      <div id="about" className="mx-auto px-4 py-12 bg-gray-900 text-white">
        <div className="flex flex-col md:flex-row items-center justify-center shadow-lg p-6 bg-opacity-20 bg-black rounded-lg">
